...
const Stats = () => {
  return (
    <div className='w-[90%] p-5 rounded-[36px] bg-divBG flex flex-col md:flex-row justify-center place-items-center ml-7 items-center z-[2] mt-20 mb-20 text-center'>
